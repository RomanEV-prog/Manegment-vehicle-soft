...
from app.schemas.homologation import (
    HomologationCreate, HomologationUpdate, HomologationResponse,
    CoCCertificateCreate, CoCCertificateResponse,
)
...
__all__ = [
    ...
    "SWUpdateCreate", "SWUpdateResponse",
    "DTCRecordCreate", "DTCRecordUpdate", "DTCRecordResponse",
    "HomologationCreate", "HomologationUpdate", "HomologationResponse",
    "CoCCertificateCreate", "CoCCertificateResponse",
    "ServiceRecordCreate", "ServiceRecordResponse",
    "AlarmEventResponse", "AlarmConfigCreate", "AlarmConfigResponse",
